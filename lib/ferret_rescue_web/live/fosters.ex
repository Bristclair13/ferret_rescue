defmodule FerretRescueWeb.Live.Fosters do
  use FerretRescueWeb, :live_view

  def render(assigns) do
    ~H"""
    <div class="flex flex-col max-w-6xl mx-auto bg-white p-6 shadow-lg drop-shadow-lg">
      <p class="mb-6">
        Most of the ferrets that are surrendered to us are of adoptable age and health. But some are either too old or have illnesses that make them "undesirable" to others. Since we are a <span class="font-bold">NO KILL SHELTER</span>, we place these ferrets in a safe, loving, forever foster home to live out the rest of their lives as comfortably as we can make it.
      </p>
      <p class="mb-6">
      ...
      <p class="mb-6">
        <span class="font-semibold">
          Fostered ferrets have no adoption fee and we cover their medical bills for life.
        </span>
        You will only be responible for providing food, toys, and a forever home.
      </p>
      <p>
